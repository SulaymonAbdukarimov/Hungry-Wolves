...
function Roadmap() {
  return (
    <div className="pt-[107px] bg-herobg w-full h-full">
      <div className="max-w-[1280px] mx-auto px-5">
        ...
        <div className="flex w-full h-full gap-5">
          <div className="w-full space-y-5">
            {/* card 1 */}
            <div className=" relative h-[350px] bg-firstcard shadow-card1 w-full  rounded-twenty border-2 border-[#7E89FD] py-5">
              <div className="max-w-[380px] h-full mx-auto px-5">
                ...
                <div className="flex justify-start items-center mt-[50px]">
                  <div className="bg-white shadow-white rounded-full w-[52px] h-[52px] flex justify-center items-center">
                    <svg
                      width="37"
                      height="28"
                      viewBox="0 0 37 28"
                  ...
                  <div className="bg-white shadow-white rounded-full w-[52px] h-[52px] flex justify-center items-center ml-[16px]">
                    <svg
              ...
              <div className="absolute textShadow-20 bottom-5 right-8 text-right  font-bold text-white text-5xl leading-[57px] tracking-[0.03em] font-condensed mt-[30px]">
                01
              </div>
            </div>
            {/*end of card 1 */}
            ...
            <div className="relative h-[450px] shadow-card1 bg-firstcard w-full rounded-twenty border-2 border-[#7E89FD] py-5">
              <div className="max-w-[380px] h-full mx-auto px-5">
                <div className="flex justify-start ml-[3px] items-center">
                  <div className="bg-white w-[18px] h-[18px] rounded shadow-white flex justify-center items-center">
                    <i className="fa-solid fa-check font-bold  text-[#2F68FF]"></i>
                ...
                <div className="pt-9 text-white font-medium text-xl font-barlow tracking-0.005">
                  Add features to eat (burn) Scrumptious Sheep / Lil Lambs and
                  earn Dominance.
                </div>
                <div className="flex justify-center items-center w-[196px] h-[180px] mt-[38px] mx-auto">
                  <img
                    className="drop-shadow-sky w-full h-full"
                    src={uchburchak}
                    alt="uchburchak"
                  />
                </div>
              ...
              <div className="absolute  textShadow-20 bottom-5 right-8 text-right font-bold  text-white text-5xl leading-[58px] tracking-[0.03em] font-condensed ">
                04
              </div>
            </div>
          ...
          <div className="w-full h-full">
            {/* Start of card 2 */}
            <div className="relative shadow-card1 h-[450px] bg-firstcard w-full rounded-twenty border-2 border-[#7E89FD] pt-[23px] ">
              <div className="max-w-[380px] h-full mx-auto px-5">
                <div className="flex justify-start ml-[3px] items-center">
                  <div className="bg-white  w-[18px] h-[18px] rounded shadow-white flex justify-center items-center">
                    <i className="fa-solid fa-check font-bold  text-[#2F68FF]"></i>
                ...
                <div className="mt-[36px] text-white font-medium text-xl font-barlow tracking-0.005">
                  Open the Wolf Den and allow all Hungry Wolves to join
                  Wolfpacks.
                </div>
                <div className=" absolute left-0 bottom-0  w-[275px] h-[275px] mt-[36px]">
              ...
              <div className=" absolute  textShadow-20 bottom-5 right-8 font-bold text-white text-5xl leading-[58px] tracking-[0.03em] font-condensed">
                02
              </div>
            </div>
            {/* End of card 2 */}
            ...
            <div className="relative shadow-card1 h-[350px] bg-firstcard mt-5 w-full rounded-twenty border-2 border-[#7E89FD] py-5 ">
              <div className="max-w-[380px] h-full mx-auto px-5">
          ...
          <div className="w-full h-full">
            {/* Start of card 3 */}
            <div className="relative shadow-card1 h-[350px] bg-firstcard mt-auto w-full rounded-twenty border-2 border-[#7E89FD] py-5">
              <div className="max-w-[380px] h-full mx-auto px-5">
                <div className="flex justify-start ml-[3px] items-center">
                  <div className="bg-white w-[18px] h-[18px] rounded shadow-white flex justify-center items-center">
                    <i className="fa-solid fa-check font-bold  text-[#2F68FF]"></i>
                ...
                <div className="flex justify-between items-end mt-[39px]">
                  <div className="w-[160px] h-[160px] absolute bottom-0 left-10">
                    <img
            ...
            {/* End of card 3 */}
            {/* Start of card 6 */}
            <div className="h-[450px] shadow-card1 bg-bgqorasmall mt-5 bg-cover w-full rounded-twenty border-2 border-[#5D5D5E] py-5 relative">
              <div className="max-w-[380px] h-full mx-auto px-5">
                <h5 className="font-bold text-xl font-condensed text-white uppercase tracking-widest">
                  Underway
                </h5>
                <div className="mt-[36px] text-white font-medium text-xl font-barlow tracking-0.005">
                  Unlock the ability for Beta wolves to challenge Alpha wolves
                  for their metadata rank.
                </div>
              ...
              <div className="absolute  textShadow-20 bottom-5 right-8 text-right  mt-[47px] font-bold  text-white text-5xl leading-[58px] tracking-[0.03em] font-condensed ">
                06
              </div>
            </div>
            {/* End of Card 6 */}
        ...
        <div className="flex mt-5 gap-5">
          {/* Start 7 cards */}
          <div className="relative bg-bgqorabig bg-cover w-1/2 h-full rounded-twenty border-2 border-[#5D5D5E] pt-[23px] ">
          ...
          {/* End 7 cards */}
          {/* Start of 8 card */}
          <div className="bg-castle bg-cover w-1/2 h-auto rounded-twenty border-2 border-[#5D5D5E] pt-[23px] before:bg-bgqorabig before:inset-0  before:w-full before:h-full relative">
            <div className="max-w-[590px] mx-auto px-5">
              <h5 className="font-bold text-xl font-condensed text-white uppercase tracking-widest">
                Underway
              </h5>
