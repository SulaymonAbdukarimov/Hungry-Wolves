  ...
  return (
    <div className="bg-slate-900 w-full h-full">
      ...
      <div className=" pt-6 w-3/5 mx-auto">
        <h1 className="uppercase font-bold text-center w-full text-white text-5xl tracking-wider not-italic">
          get Your <span className="text-[#825AFC] ">hungry wolf</span>
        </h1>
        <p className="text-white text-1xl tracking-wider leading-6 text-center max-w-2xl mx-auto py-5">
        ...
        <button className="bg-[#2F68FF] hover:bg-[#2153da]   shadow-xl shadow-[#2F68FF] transition duration-200 text-white font-bold uppercase text-1xl leading-3 flex justify-center items-center px-5 py-4 rounded-lg text-center mx-auto">
      ...
      <div className="w-full">
        <div className="">
          <div className="w-80 h-80">
            <img className="w-full h-full object-cover" src={wolf1} alt="wolf" />
          </div>
        </div>
      </div>
    </div>
