...
function MobileHero() {
  ...
  const social = [
    {
      id: 1,
      name: "Discord",
      url: "https://discord.com/invite/hungrywolves",
      icon: (
    ...
    },
    {
      ...
      url: "https://twitter.com/HungryWolvesNFT",
    },
    {
      id: 3,
      name: "opensea",
      url: "https://opensea.io/collection/hungry-wolves",
      icon: (
        <a href="https://t.me/Sulaymon_Abdukarimov" target="_blank">
          <svg
  ...
  return (
    <div className="relative w-full h-full bg-mobile pt-10 px-5">
      <div>
        <ul>
          {links.map((item) => (
            <li className="pb-5">
              <NavLink
                to={item.url}
                className="font-condensed font-bold text-2xl leading-7 tracking-wider uppercase text-white"
                key={item.id}
              >
                {item.name}
              </NavLink>
      ...
      <div className="absolute top-1/2 left-1/2 opacity-25 bg-coolbg  blur-[200px] rounded-full  w-2/3 h-full  transform -translate-x-1/2 -translate-y-1/2 z-0"></div>
      <div className="h-[2px] bg-line w-full block  mt-11"></div>
      <div className="mt-11 relative z-10">
        {social.map((item) => (
          ...
          >
            <h3 className="font-condensed font-bold text-2xl leading-7 tracking-wider uppercase text-white">
              {item.name}
            </h3>
      ...
      <p className="mt-5 pb-[70px] font-condensed font-medium text-sm leading-4 tracking-widest uppercase text-white">
        © Wolfpack Labs LLC
      </p>
    </div>
  );
